...
export const en: Translations = {
  ...
  'save.invalid': 'The server rejected these edits because the data or revision is invalid. Your edits are still here. Reload the latest version before trying again.',
